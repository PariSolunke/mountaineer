...
const MapperGraph = ({mapper_outputs, overlaps, birefMapperGraph, dataframe, columns, lasso, minElements, maxElements, mapperId, expl_labels, kk_layouts, kk_flag, initial_name}) => {

  //state to check filtered data
  const [state,setState]=useState({selectedMapper:mapperId-1, nodeColorBy:initial_name, nodeColorAgg:"mean"});
